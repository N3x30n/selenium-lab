...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name('q')).sendKeys('Stardew', Key.RETURN)
  await driver.wait(until.titleIs('Stardew - Google Search'), 1000)
  ...
  await driver.findElement(By.name('q')).sendKeys('Minecraft', Key.RETURN)
  await driver.wait(until.titleIs('Minecraft - Google Search'))
